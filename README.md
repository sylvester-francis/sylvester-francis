...
- [Go and Rust Will Not Save Your Agent Loop. The Boundary Will.](https://medium.com/@sylvesterranjithfrancis/go-and-rust-will-not-save-your-agent-loop-the-boundary-will-3f041b8f62ce?source=rss-b2e231d8e9db------2)
- [Reasoning models have a stopping problem](https://medium.com/@sylvesterranjithfrancis/reasoning-models-have-a-stopping-problem-02cf0e4495b0?source=rss-b2e231d8e9db------2)
- [AI Writes the Code Now. Understanding the System Is Your Job.](https://medium.com/@sylvesterranjithfrancis/ai-writes-the-code-now-understanding-the-system-is-your-job-bd9b500a5bc5?source=rss-b2e231d8e9db------2)
...
- [The agent loop is now infrastructure. Someone still has to pay for it.](https://techwithsyl.substack.com/p/the-agent-loop-is-now-infrastructure)
- [Agentic AI hit the Gartner peak. Getting down the other side is a plumbing job](https://techwithsyl.substack.com/p/agentic-ai-hit-the-gartner-peak-getting)
